...
(define-read-only (get-random-113)
  (ok u113))
...
(define-read-only (get-random-210)
  (ok u210))

(define-read-only (get-random-280)
  (ok u280))
...
(define-read-only (get-random-146)
  (ok u146))
...
(define-read-only (get-random-273)
  (ok u273))
...
(define-read-only (get-random-171)
  (ok u171))

(define-read-only (get-random-186)
  (ok u186))

(define-read-only (get-random-194)
  (ok u194))

(define-read-only (get-random-296)
  (ok u296))
...
(define-read-only (get-random-220)
  (ok u220))

(define-read-only (get-random-244)
  (ok u244))
