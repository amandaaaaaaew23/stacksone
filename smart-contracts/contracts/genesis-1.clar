...
(define-read-only (get-random-70)
  (ok u70))

(define-read-only (get-random-87)
  (ok u87))
...
(define-read-only (get-random-119)
  (ok u119))

(define-read-only (get-random-41)
  (ok u41))
...
(define-read-only (get-random-259)
  (ok u259))

(define-read-only (get-random-20)
  (ok u20))

(define-read-only (get-random-67)
  (ok u67))
...
(define-read-only (get-random-180)
  (ok u180))
...
(define-read-only (get-random-31)
  (ok u31))
...
(define-read-only (get-random-162)
  (ok u162))

(define-read-only (get-random-172)
  (ok u172))

(define-read-only (get-random-18)
  (ok u18))
...
(define-read-only (get-random-99)
  (ok u99))
...
(define-read-only (get-random-157)
  (ok u157))
...
(define-read-only (get-random-284)
  (ok u284))

(define-read-only (get-random-38)
  (ok u38))

(define-read-only (get-random-53)
  (ok u53))
...
(define-read-only (get-random-22)
  (ok u22))

(define-read-only (get-random-102)
  (ok u102))

(define-read-only (get-random-121)
  (ok u121))

(define-read-only (get-random-155)
  (ok u155))
...
(define-read-only (get-random-95)
  (ok u95))
