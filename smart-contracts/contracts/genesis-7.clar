...
(define-read-only (get-random-39)
  (ok u39))
...
(define-read-only (get-random-122)
  (ok u122))
...
(define-read-only (get-random-117)
  (ok u117))
...
(define-read-only (get-random-160)
  (ok u160))

(define-read-only (get-random-182)
  (ok u182))
...
(define-read-only (get-random-205)
  (ok u205))
...
(define-read-only (get-random-106)
  (ok u106))

(define-read-only (get-random-17)
  (ok u17))

(define-read-only (get-random-177)
  (ok u177))

(define-read-only (get-random-210)
  (ok u210))

(define-read-only (get-random-268)
  (ok u268))
...
(define-read-only (get-random-185)
  (ok u185))
...
(define-read-only (get-random-189)
  (ok u189))
